...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT_all(
		...
		KC_LCTL, KC_LALT, MO(1), KC_SPC, KC_SPC, KC_SPC, MO(2), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
	...
	LAYOUT_all(
		...
		KC_TRNS, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
...
+-------+---+---+---+---+---+---+---+---+---+---+---+---+---+
| LSFT  | Z | X | C | V | B | N | M | , | . | \ | H | U | E |
+----+----+----+------------------------+---+---+---+---+---+
|LCTL|LALT| FN |                        | FN|CTL| L | D | R |
+----+----+----+------------------------+---+---+---+---+---+
